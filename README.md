# KServe
[![go.dev reference](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white)](https://pkg.go.dev/github.com/akravacyber/kserve)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/akravacyber/kserve)](https://goreportcard.com/report/github.com/akravacyber/kserve)
[![Releases](https://img.shields.io/github/release-pre/kserve/kserve.svg?sort=semver)](https://github.com/akravacyber/kserve/releases)
[![LICENSE](https://img.shields.io/github/license/kserve/kserve.svg)](https://github.com/akravacyber/kserve/blob/master/LICENSE)
...
_Since 0.7 [KFServing is rebranded to KServe](https://blog.kubeflow.org/release/official/2021/09/27/kfserving-transition.html), we still support previous KFServing [0.5.x](https://github.com/akravacyber/kserve/tree/release-0.5) and 
[0.6.x](https://github.com/akravacyber/kserve/tree/release-0.6) releases, please refer to corresponding release branch for docs_.
